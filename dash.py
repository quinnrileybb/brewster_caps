...
df = pd.read_csv('YarmouthDennis_Hitters_NCAA_2025_.csv')

# -------------------------
# Page & Login Configuration
# -------------------------
st.set_page_config(page_title="Yarmouth-Dennis Hitters", layout="wide")
# Persistent small logo in the top-right corner.

st.success("Yarmouth-Dennis Red Sox Hitters")
